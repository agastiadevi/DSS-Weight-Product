                            ...
                            <table class="table is-fullwidth">
                                <thead class="has-background-dark">
                                    ...
                                    <?php foreach ($alternatif as $row) : ?>
                                        ...
                                        <?php $a = round(round($test[$i], 3) / round($totalS, 3), 3) ?>
                                        <?php $i++ ?>
                                        <?php $j++ ?>
                                        <?php $b = $row['nm_les'] ?>
                                        <?php $array[] = array('nama' => $b, 'nilai' => $a); ?>
                                    <?php endforeach ?>
                                    <?php
                                        $m = array_column($array, 'nilai'); //get kolom array for sorting
                                        array_multisort($m, SORT_DESC, $array); //sorting
                                        $jk = array_values($array); //declare array values
                                    ?>
                                <tbody>
